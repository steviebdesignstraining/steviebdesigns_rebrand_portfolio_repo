  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <main className="flex-1">
        <section id="home" className="relative flex items-center justify-center text-center py-16 sm:py-20 scroll-mt-20">
          <MotionDiv className="space-y-4 px-4" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <Image src="/logo/steviebdesigns Without Slogan.png" alt="Steviebdesigns" width={120} height={32} className="h-8 w-auto" />
              </div>
